...
#if !defined(ENABLE_LDRA_COVERAGE)
   int svd_status =
       DSPF_sp_svd_cn<dataType>(pKerPrivArgs, heightIn, widthIn, pALocal, pULocal, pVLocal, pU1Local, pV1Local,
                                pDiagLocal, pSuperDiagLocal, strideIn, strideU, strideV, enableReducedForm);
   if (svd_status < 0) {
