...
template <typename dataType> void DSPLIB_debugPrint3DVReg_helperU(dataType *matrix, const DSPLIB_bufParams3D_t *params)
{
   uint32_t  r, c, t;
   dataType *xPtr;
   dataType *yPtr;
...
template void DSPLIB_debugPrint3DVReg_helperU<uint16_t>(uint16_t *matrix, const DSPLIB_bufParams3D_t *params);
...
void DSPLIB_debugPrint3DVReg(void *matrix, const DSPLIB_bufParams3D_t *params)
{
   ...
   case DSPLIB_INT16:
      ...
      break;
   case DSPLIB_UINT16:
      DSPLIB_debugPrint3DVReg_helperU<uint16_t>((uint16_t *) matrix, params);
      break;
   case DSPLIB_INT8:
