...
DSPLIB_STATUS DSPLIB_cascadeBiquad_df2_init_ci(DSPLIB_kernelHandle                  handle,
                                               ...
                                               const DSPLIB_cascadeBiquad_InitArgs *pKerInitArgs)
{
   ...
   uint32_t numStageGroups = numStages / DSPLIB_CASCADEBIQUAD_DF2_STAGES_PER_STAGE_GROUP;
   // Calculate remaining stages
   uint32_t remStages = numStages % DSPLIB_CASCADEBIQUAD_DF2_STAGES_PER_STAGE_GROUP;
...
template DSPLIB_STATUS DSPLIB_cascadeBiquad_df2_init_ci<float>(DSPLIB_kernelHandle         handle,
                                                               const DSPLIB_bufParams2D_t *bufParamsIn,
                                                               const DSPLIB_bufParams2D_t *bufParamsFilterCoeff,
                                                               const DSPLIB_bufParams2D_t *bufParamsFilterVar,
                                                               const DSPLIB_bufParams2D_t *bufParamsOut,
...
template <typename dataType>
DSPLIB_STATUS DSPLIB_cascadeBiquad_df2_exec_ci(DSPLIB_kernelHandle handle,
                                               void *restrict pIn,
...
#pragma MUST_ITERATE(1, , )
         for (uint32_t samp = 0; samp < dataSize; samp++) {
            ...
            // Calculate stage 1
            wd0_1    = input - a1_1 * wd1_1 - a2_1 * wd2_1;
            output_1 = b0_1 * wd0_1 + b1_1 * wd1_1 + b2_1 * wd2_1;
            wd2_1    = wd1_1;
            wd1_1    = wd0_1;

            // Calculate stage 2
            wd0_2    = output_1 - a1_2 * wd1_2 - a2_2 * wd2_2;
            output_2 = b0_2 * wd0_2 + b1_2 * wd1_2 + b2_2 * wd2_2;
            wd2_2    = wd1_2;
            wd1_2    = wd0_2;
...
template DSPLIB_STATUS DSPLIB_cascadeBiquad_df2_exec_ci<float>(DSPLIB_kernelHandle handle,
                                                               void *restrict pIn,
                                                               void *restrict pFilterCoeff,
                                                               void *restrict pFilterVar,
                                                               void *restrict pOut);
