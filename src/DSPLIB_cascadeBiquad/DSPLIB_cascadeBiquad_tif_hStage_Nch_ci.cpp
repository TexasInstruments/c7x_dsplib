...
DSPLIB_STATUS DSPLIB_cascadeBiquad_tif_hStage_Nch_init_ci(DSPLIB_kernelHandle                  handle,
                                                          ...
                                                          const DSPLIB_cascadeBiquad_InitArgs *pKerInitArgs)
{
   ...
   /**********************************************************************/
   /* Prepare SE0/1 template to read the filter coefficients             */
   /**********************************************************************/
   se1Params               = __gen_SE_TEMPLATE_v1();
   se1Params.ICNT0         = icnt0Param;
   se1Params.ICNT1         = DSPLIB_CASCADEBIQUAD_TIF_SE_NUM_BIQUAD_COEF;
   se1Params.DIM1          = (int32_t) eleCount * numStages * numChannelGroups;
   se1Params.ICNT2         = stagesPerStageGroup;
   se1Params.DIM2          = (int32_t) eleCount * numChannelGroups;
   se1Params.ICNT3         = dataSize;
   se1Params.DIM3          = 0;
   se1Params.ICNT4         = numStageGroups;
   se1Params.DIM4          = (int32_t) eleCount * stagesPerStageGroup * numChannelGroups;
   se1Params.ICNT5         = numChannelGroups;
   se1Params.DIM5          = (int32_t) eleCount;
   se1Params.ELETYPE       = SE_ELETYPE;
   se1Params.VECLEN        = SE_VECLEN;
   se1Params.DECDIM1_WIDTH = eleCount * numStages * numChannelGroups;
   ...
   sa1Params.ICNT1         = stagesPerStageGroup * DSPLIB_NUM_STATE_VARS_DF2;
   sa1Params.DIM1          = (int32_t) filterVarPitch;
   sa1Params.ICNT2         = numStageGroups;
   sa1Params.DIM2          = (int32_t) numChannels * stagesPerStageGroup * DSPLIB_NUM_STATE_VARS_DF2;
   sa1Params.ICNT3         = numChannelGroups;
   sa1Params.DIM3          = (int32_t) eleCount;
   sa1Params.VECLEN        = SA_VECLEN;
   sa1Params.DECDIM1_WIDTH = numChannels;
   sa1Params.DECDIM1       = __SA_DECDIM_DIM3;
   sa1Params.DECDIM2_WIDTH = numChannels * numStages * DSPLIB_NUM_STATE_VARS_DF2;
   sa1Params.DECDIM2       = __SA_DECDIM_DIM2;
   sa1Params.DECDIM2SD     = __SA_DECDIMSD_DIM1;
   ...
   sa3Params.ICNT1         = stagesPerStageGroup * DSPLIB_NUM_STATE_VARS_DF2;
   sa3Params.DIM1          = (int32_t) numChannels;
   sa3Params.ICNT2         = numStageGroups;
   sa3Params.DIM2          = (int32_t) numChannels * stagesPerStageGroup * DSPLIB_NUM_STATE_VARS_DF2;
   sa3Params.ICNT3         = numChannelGroups;
   sa3Params.DIM3          = (int32_t) eleCount;
   sa3Params.VECLEN        = SA_VECLEN;
   sa3Params.DECDIM1_WIDTH = numChannels;
   sa3Params.DECDIM1       = __SA_DECDIM_DIM3;
   sa3Params.DECDIM2_WIDTH = numChannels * numStages * DSPLIB_NUM_STATE_VARS_DF2;
   sa3Params.DECDIM2       = __SA_DECDIM_DIM2;
   sa3Params.DECDIM2SD     = __SA_DECDIMSD_DIM1;
...
DSPLIB_cascadeBiquad_tif_hStage_Nch_init_ci<float>(DSPLIB_kernelHandle                  handle,
                                                   const DSPLIB_bufParams2D_t          *bufParamsIn,
                                                   const DSPLIB_bufParams2D_t          *bufParamsFilterCoeff,
                                                   const DSPLIB_bufParams2D_t          *bufParamsFilterVar,
                                                   const DSPLIB_bufParams2D_t          *bufParamsOut,
 ...
 ******************************************************************************/
template <typename dataType>
DSPLIB_STATUS DSPLIB_cascadeBiquad_tif_4Stage_Nch_exec_ci(DSPLIB_kernelHandle handle,
                                                          void *restrict pIn,
                                                          ...
                                                          void *restrict pOut)
{
   ...
   uint32_t numChannelsVecLen = (numChannels + eleCount - 1) / eleCount * eleCount;
   uint32_t offset;
   ...
   offset = numStages * DSPLIB_CASCADEBIQUAD_TIF_SE_NUM_BIQUAD_COEF * numChannelsVecLen;
   ...
   // initialize gain pointer
   offset    = numStages * DSPLIB_NUM_TIF_BIQUAD_COEFS * numChannelsVecLen;
   pGainBuff = (dataType *) pFilterCoeff + offset;
   pGainVec  = (vec *) pGainBuff;
...
#pragma MUST_ITERATE(1, , )
   for (uint32_t chCount = 0; chCount < numChannels; chCount += eleCount) {
      ...
      // Read aggregate gain for channel group
      outGain = *pGainVec;
      pGainVec++;
...
#pragma MUST_ITERATE(1, , )
      for (uint32_t samp = 0; samp < dataSize; samp++) {
         ...
         vec     input = __vload_pred(tmpld, VB3);
...
template DSPLIB_STATUS DSPLIB_cascadeBiquad_tif_4Stage_Nch_exec_ci<float>(DSPLIB_kernelHandle handle,
                                                                          void *restrict pIn,
                                                                          void *restrict pFilterCoeff,
                                                                          void *restrict pFilterVar,
                                                                          void *restrict pOut);
...
template <typename dataType>
DSPLIB_STATUS DSPLIB_cascadeBiquad_tif_5Stage_Nch_exec_ci(DSPLIB_kernelHandle handle,
                                                          void *restrict pIn,
                                                          void *restrict pFilterCoeff,
                                                          void *restrict pFilterVar,
                                                          void *restrict pOut)
...
template DSPLIB_STATUS DSPLIB_cascadeBiquad_tif_5Stage_Nch_exec_ci<float>(DSPLIB_kernelHandle handle,
                                                                          void *restrict pIn,
                                                                          void *restrict pFilterCoeff,
                                                                          void *restrict pFilterVar,
                                                                          void *restrict pOut);
...
template <typename dataType>
DSPLIB_STATUS DSPLIB_cascadeBiquad_tif_6Stage_Nch_exec_ci(DSPLIB_kernelHandle handle,
                                                          void *restrict pIn,
                                                          void *restrict pFilterCoeff,
                                                          void *restrict pFilterVar,
                                                          void *restrict pOut)
...
template DSPLIB_STATUS DSPLIB_cascadeBiquad_tif_6Stage_Nch_exec_ci<float>(DSPLIB_kernelHandle handle,
                                                                          void *restrict pIn,
                                                                          void *restrict pFilterCoeff,
                                                                          void *restrict pFilterVar,
                                                                          void *restrict pOut);
...
template <typename dataType>
DSPLIB_STATUS DSPLIB_cascadeBiquad_tif_8Stage_Nch_exec_ci(DSPLIB_kernelHandle handle,
                                                          void *restrict pIn,
                                                          void *restrict pFilterCoeff,
                                                          void *restrict pFilterVar,
                                                          void *restrict pOut)
...
template DSPLIB_STATUS DSPLIB_cascadeBiquad_tif_8Stage_Nch_exec_ci<float>(DSPLIB_kernelHandle handle,
                                                                          void *restrict pIn,
                                                                          void *restrict pFilterCoeff,
                                                                          void *restrict pFilterVar,
                                                                          void *restrict pOut);
...
template <typename dataType>
DSPLIB_STATUS DSPLIB_cascadeBiquad_tif_MStage_Nch_exec_ci(DSPLIB_kernelHandle handle,
                                                          void *restrict pIn,
                                                          void *restrict pFilterCoeff,
                                                          void *restrict pFilterVar,
                                                          void *restrict pOut)
{
   ...
   dataType *pOutLocal         = (dataType *) pOut;
   dataType *pGainBuff;
   vec      *pGainVecBase, *pGainVec;

   uint32_t eleCount = c7x::element_count_of<vec>::value;

   uint32_t numChannelVecs    = (numChannels + eleCount - 1) / eleCount;
   uint32_t numChannelsVecLen = numChannelVecs * eleCount;
   uint32_t offset;
   ...
   offset       = numStages * DSPLIB_NUM_TIF_BIQUAD_COEFS * numChannelsVecLen;
   pGainBuff    = (dataType *) pFilterCoeff + offset;
   pGainVecBase = (vec *) pGainBuff;

#pragma MUST_ITERATE(1, , )
   for (uint32_t chCount = 0; chCount < numChannels; chCount += eleCount) {
      // Set gain pointer for current channel group
      pGainVec = pGainVecBase;
      pGainVecBase++;
...
#pragma MUST_ITERATE(1, , )
      for (uint32_t stageCount = 0; stageCount < numStageGroups; stageCount++) {
         ...
         // Read aggregate gain for stage group
         outGain = *pGainVec;
         pGainVec += numChannelVecs;
...
template DSPLIB_STATUS DSPLIB_cascadeBiquad_tif_MStage_Nch_exec_ci<float>(DSPLIB_kernelHandle handle,
                                                                          void *restrict pIn,
                                                                          void *restrict pFilterCoeff,
                                                                          void *restrict pFilterVar,
                                                                          void *restrict pOut);
