...
#ifndef DSPLIB_INTEREAVE_IXX_IXX_OXX_H_
#define DSPLIB_INTEREAVE_IXX_IXX_OXX_H_
...
/*!
 * @defgroup DSPLIB_interleave DSPLIB_interleave
 * @brief Kernel for interleave of input matrix.
 *
 * @details
 *          - This kernel interleaves the given input matrix and stores it in
 *            an output matrix.
 ...
 *               @ref DSPLIB_interleave_exec function is called. This
 ...
 *               @ref DSPLIB_interleave_init function. This function
 *               is called with the same parameters as the
 *               @ref DSPLIB_interleave_init, and this function
 *               must be called before the
 *               @ref DSPLIB_interleave_init is called.
 *
 *  @param [in]  handle       :  Active handle to the kernel
 *  @param [in]  bufParamsIn  :  Pointer to the structure containing dimensional
 *                               information of input buffer
...
/*!
 *  @brief       This function checks the validity of the parameters passed to
 *               @ref DSPLIB_interleave_exec function. This function
 *               is called with the same parameters as the
 *               @ref DSPLIB_interleave_exec, and this function
 *               must be called before the
 *               @ref DSPLIB_interleave_exec is called.
 *
 *  @param [in]  handle :  Active handle to the kernel
 ...
 *               @ref DSPLIB_interleave_init and
 *               @ref DSPLIB_interleave_exec_checkParams functions.
...
#endif /* DSPLIB_INTEREAVE_IXX_IXX_OXX_H_ */
