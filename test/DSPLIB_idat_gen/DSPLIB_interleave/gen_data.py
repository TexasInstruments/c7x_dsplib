...
def gen_testCaseParams(testParamsFile, currPrm):
    ...
    C7100 = currPrm["C7100"]
    testId = currPrm["ID"]
    enableStrideOut = currPrm["enableStrideOut"]
    ...
    if enableStrideOut == "FALSE":
        idatFile.write("%s, // strideOut \n" % ((strideOut)))
    else:
        idatFile.write(
...
def gen_idat_file(idatFile, testCases):
    ...
    includeString = '#include "DSPLIB_interleave_idat.h"'
    ...
    idatFile.write("static DSPLIB_interleave_testParams_t testParams[] =  ")
    idatFile.write("{\n")
...
idatFileName = "../../DSPLIB_interleave/DSPLIB_interleave_idat.c"
